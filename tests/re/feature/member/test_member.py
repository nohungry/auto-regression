...
class TestPersonalInfo:
    """RE-TC-011 ~ RE-TC-012：個人資訊彈窗"""

    def test_personal_info_opens(self, class_logged_in_page: Page, go_home, site_config):
        """RE-TC-011：個人資訊彈窗可正常開啟，帳號欄位顯示正確用戶名

        斷言策略：username 欄位 disabled，verify 與 site_config.username 完全一致；
        截圖 label 帶 username 為對照用，非動態值。
        """
