...
語系切換後的實際文案驗證，請參考：
- tests/re/feature/i18n/test_home_locale.py      首頁 nav 文案
- tests/re/feature/i18n/test_login_locale.py     登入表單文案
- tests/re/feature/i18n/test_sidebar_locale.py   側邊欄文案
"""
...
class TestLanguageDropdown:
    ...
    def test_dropdown_has_six_languages(self, page: Page, site_config):
        """RE-TC-L01：globe icon 下拉選單應有 6 個語系，且每個語系名稱可見"""
