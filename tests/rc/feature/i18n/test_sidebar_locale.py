"""
多語系文案驗證 — 側邊欄選單項目
RC-I18N-SIDEBAR-001~006

RC 側邊欄（.sidebar-item）對應 LT 的 hamburger drawer：
...
_SIDEBAR_LOCALE_CHECKS = [
    ...
    ("RC-I18N-SIDEBAR-001", "繁體中文",   "個人資訊",           "遊戲明細",          "站內信"),
    ("RC-I18N-SIDEBAR-002", "簡体中文",   "个人信息",           "游戏明细",          "站内信"),
    ("RC-I18N-SIDEBAR-003", "日本語",     "個人情報",           "ゲーム履歴",        "サイト内メール"),
    ("RC-I18N-SIDEBAR-004", "ภาษาไทย",   "ข้อมูลส่วนตัว",     "รายละเอียดเกม",   "กล่องข้อความ"),
...
class TestI18NSidebar:
    """RC-I18N-SIDEBAR-001~006：各語系側邊欄選單文案驗證"""
