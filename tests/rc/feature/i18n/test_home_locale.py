...
_HOME_LOCALE_CHECKS = [
    ...
    ("RC-I18N-HOME-001", "繁體中文", ["首頁", "真人", "電子", "捕魚", "登入"],                                          "繁中首頁文案"),
    ("RC-I18N-HOME-002", "簡体中文", ["首页", "真人", "电子", "捕鱼", "登录"],                                          "簡中首頁文案"),
    ("RC-I18N-HOME-003", "日本語",   ["トップ", "ライブ", "電子", "フィッシング", "ログイン"],                             "日文首頁文案"),
    ("RC-I18N-HOME-004", "ภาษาไทย", ["หน้าแรก", "ถ่ายทอดสด", "อิเล็กทรอนิกส์", "เกมยิงปลา", "เข้าสู่ระบบ"],        "泰文首頁文案"),
    ("RC-I18N-HOME-005", "Tiếng Việt", ["Trang đầu", "Người thật", "Điện tử", "Câu cá", "Đăng nhập"],               "越文首頁文案"),
    ("RC-I18N-HOME-006", "English",  ["Home", "Live Casino", "Slots", "Fishing", "Login"],                           "英文首頁文案"),
]
...
class TestI18NHome:
    """RC-I18N-HOME-001~006：多語系首頁 nav 文案驗證"""
