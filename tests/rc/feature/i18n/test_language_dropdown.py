...
語系切換後的實際文案驗證，請參考：
- tests/rc/feature/i18n/test_home_locale.py      首頁 nav 文案
- tests/rc/feature/i18n/test_login_locale.py     登入表單文案
- tests/rc/feature/i18n/test_sidebar_locale.py   側邊欄文案
"""
