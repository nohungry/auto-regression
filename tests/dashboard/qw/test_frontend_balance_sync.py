...
帳號：前台 = SITE_QW_USERNAME（class_logged_in_page，站點 conftest 已指向本站），
後台 = SITE_QW_DASHBOARD_USER 站長（dashboard_page）。**兩者不同帳號故不互踢**
...
class TestFrontendBalanceSync:
    """QW-DASH-SYNC-001：後台調整額度後，前台會員餘額同步反映且可還原。"""
