...
tests/dashboard/<site_id>/   — backend dashboard tests (rc/re top_up; lt re-export; lu login+TOTP 2FA smoke); state-mutating tests should be reversible (rollback / teardown compensation)
